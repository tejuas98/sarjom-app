...
export const UI_TRANSLATIONS = {
  hi: {
    ...
    // Worksheets Studio
    wsTitle: 'निपुण भारत द्विभाषी अभ्यास पत्र स्टूडियो (Worksheet Studio)',
    wsSubtitle: 'FLN बुनियादी साक्षरता एवं संख्या ज्ञान • हिंदी एवं जनजातीय भाषाओं में स्वतः निर्मित अभ्यास पत्र',
    wsPedagogyNote: 'निपुण भारत के अंतर्गत मातृभाषा आधारित बहुभाषी शिक्षण (MTB-MLE) सेतु — जनजातीय बच्चों के लिए हिंदी में सहज प्रवेश',
    wsModeInteractive: 'संवादात्मक टैबलेट मोड (Interactive)',
    wsModePrintable: 'प्रिंटेबल A4 कार्य-पुस्तिका (Print View)',
    wsAnswerKey: 'शिक्षक उत्तर कुंजी (Answer Key)',
    wsTypeNumeracy: 'संख्या ज्ञान (गिनती 1-10)',
    wsTypeMatching: 'शब्द-चित्र मिलान',
    wsTypeFillBlanks: 'वाक्य पूर्ति अभ्यास (Cloze)',
    wsTypeAnimals: 'पशु-पक्षी व वस्तु पहचान',
    wsTypeTracing: 'लिपि अनुरेखण (Tracing)',
    wsTypeScramble: 'अक्षर संयोजन (Scramble)',
    wsTopicLabel: 'विषय (Topic):',
    wsTopicAll: 'सभी विषय',
    wsTopicNumbers: 'संख्याएँ एवं गिनती',
    wsTopicAnimals: 'पशु-पक्षी',
    wsTopicNature: 'प्रकृति एवं जल',
    wsTopicFamily: 'परिवार एवं रिश्ते',
    wsTopicClassroom: 'कक्षा निर्देश व वस्तुएँ',
    wsPrintBtn: 'प्रिंट / PDF सेव करें',
    wsCheckBtn: 'उत्तर जाँचें (Check)',
    wsResetBtn: 'पुनः प्रयास करें',
    wsShuffleBtn: 'नया अभ्यास पत्र तैयार करें',
    wsCheckedToast: 'अभ्यास पत्र सफलता पूर्वक जाँचा गया! बहुत बढ़िया!',
    wsSchoolLabel: 'विद्यालय:',
    wsStudentLabel: 'विद्यार्थी का नाम:',
    wsDateLabel: 'दिनांक:',
    wsScoreLabel: 'प्राप्तांक:',
    wsGradeLabel: 'कक्षा:',
    wsRollLabel: 'क्रमांक (Roll No):',
    wsEmblemGovt: 'झारखंड सरकार • GOVT. OF JHARKHAND',
    wsEmblemDept: 'स्कूली शिक्षा एवं साक्षरता विभाग • निपुण भारत मातृभाषा शिक्षण (MTB-MLE)',
  ...
  en: {
    ...
    wsSubtitle: 'FLN Foundational Literacy & Numeracy • Auto-generated printable & interactive bilingual exercises',
    wsPedagogyNote: 'Mother Tongue-Based Multilingual Education (MTB-MLE) Bridging Tool under NIPUN Bharat — scaffolding tribal students to Hindi',
    wsModeInteractive: 'Interactive Tablet Practice',
    wsModePrintable: 'Printable A4 Sheet View',
    wsAnswerKey: 'Teacher Answer Key',
    wsTypeNumeracy: 'Numeracy & Counting (1-10)',
    wsTypeMatching: 'Picture & Word Matching',
    wsTypeFillBlanks: 'Sentence Completion (Cloze)',
    wsTypeAnimals: 'Animals & Nature Quiz',
    wsTypeTracing: 'Orthographic Script Tracing',
    wsTypeScramble: 'Letter Scramble & Anagrams',
    wsTopicLabel: 'Topic:',
    wsTopicAll: 'All Curriculum Topics',
    wsTopicNumbers: 'Numbers & Counting',
    wsTopicAnimals: 'Animals & Birds',
    wsTopicNature: 'Nature, Trees & Water',
    wsTopicFamily: 'Family & Kinship',
    wsTopicClassroom: 'Classroom & School',
    wsPrintBtn: 'Print / Save PDF',
    wsCheckBtn: 'Check Answers',
    wsResetBtn: 'Try Again',
    wsShuffleBtn: 'Generate Fresh Worksheet',
    wsCheckedToast: 'Worksheet evaluated! Outstanding score!',
    wsSchoolLabel: 'School:',
    wsStudentLabel: 'Student Name:',
    wsDateLabel: 'Date:',
    wsScoreLabel: 'FLN Score:',
    wsGradeLabel: 'Grade:',
    wsRollLabel: 'Roll No:',
    wsEmblemGovt: 'GOVERNMENT OF JHARKHAND',
    wsEmblemDept: 'Department of School Education & Literacy • NIPUN Bharat MTB-MLE',
