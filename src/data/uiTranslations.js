...
export const UI_TRANSLATIONS = {
  hi: {
    ...
    modeTeacherToStudent: '🗣️ शिक्षक ➔ कक्षा स्पीकर (One-Tap Speak)',
    modeStudentToTeacher: '👂 छात्र ➔ शिक्षक (Reverse Ear)',
    tapToSpeakIdle: '🎙️ यहाँ दबाकर बोलें (Tap to Speak)',
    ...
    youSpoke: 'आपने बोला:',
    pronounceAs: '🗣️ ऐसे बोलें:',
    replaySpeaker: '🔊 दोबारा स्पीकर पर सुनाएं',
    quickCommandsTitle: '⚡ कक्षा में तुरंत बोलने वाले 8 आम निर्देश (टैप करते ही स्पीकर पर बोलेगा):',
    ...
    autonomousHint: '💡 शिक्षक को पूर्ण स्वतंत्रता: AI शिक्षक का उत्तर तय नहीं करेगा। छात्र की बात सुनकर जो भी बोलना चाहें, अपनी भाषा में बोलें या लिखें — सिस्टम तुरंत छात्र की मातृभाषा में अनुवाद करेगा।',
    speakReplyBtn: '🎙️ अपना उत्तर बोलें (Speak Your Response)',
    ...
    emptyLogText: 'ऊपर माइक बटन दबाकर बोलें या 1-टैप निर्देश चुनें। यहाँ कक्षा संवाद स्वतः दर्ज होता रहेगा।',
    roleTeacher: '👨‍🏫 शिक्षक:',
    roleStudent: '🧒 छात्र:',
    ...
    footerDevBarToggle: '⚙️ तकनीकी सिमुलेटर बार',
  ...
  en: {
    ...
    // Voice Translator (Classroom Speak)
    modeTeacherToStudent: '🗣️ Teacher ➔ Class Speaker (One-Tap Speak)',
    modeStudentToTeacher: '👂 Student ➔ Teacher (Reverse Ear)',
    tapToSpeakIdle: '🎙️ Tap Here to Speak & Broadcast',
    ...
    autonomousHint: '💡 100% Teacher Autonomy: The system never dictates what you say. Express your real instructions in English or Hindi — SARJOM instantly speaks it in the child\'s native language.',
    speakReplyBtn: '🎙️ Speak Your Response (English / Hindi)',
    ...
    footerDevBarToggle: '⚙️ Technical Simulator Bar',
