  ...
  <div class="page">
    <div class="header">
      ...
      <div style="text-align: right; font-size: 9px; color: #64748b;">
        <div>Document Version: 2.4-Master</div>
    ...
    <div class="slide-blueprint">
      <div class="slide-header">
        ...
        <div style="font-size: 9.5px; color: #94a3b8;">Smart India Hackathon 2026 • SIH26042</div>
      </div>
      <div class="slide-body">
        <!-- Left Side: Killer Contrast -->
        <div class="slide-card">
          <div class="slide-card-title">🥊 The Killer Contrast: Existing vs. SARJOM</div>
          <table style="color: #f8fafc; font-size: 9px; margin-bottom: 4px;">
            <tr>
          ...
          <div style="font-size: 8.5px; color: #e2e8f0; margin-top: 4px; border-top: 1px solid #334155; padding-top: 4px;">
        ...
        <div class="slide-card">
          ...
          <div style="font-size: 8.5px; color: #cbd5e1; line-height: 1.4;">
            <div style="margin-bottom: 3px;">• <b>UDISE+ & Census:</b> 5,280 schools, 1.48M ST children; 38.4% attrition between Gr 1-5.</div>
            <div style="margin-bottom: 3px;">• <b>ASER 2022:</b> 82.8% of tribal Gr 3 students cannot read Gr 2 Hindi due to initial language shock.</div>
            <div style="margin-bottom: 3px;">• <b>NEP 2020 §4.11:</b> Direct execution of mother-tongue medium & bilingual learning materials.</div>
            <div style="margin-bottom: 3px;">• <b>Cummins' CUP:</b> Cognitive concepts mastered in Ho transfer permanently to Hindi & English.</div>
          </div>
          <div style="margin-top: 6px; padding: 4px; background: #0f172a; border-radius: 4px; font-size: 8px; color: #94a3b8; display:flex; justify-content:space-between; align-items:center;">
    ...
    <div class="footer">
      ...
      <span>Page 1 of 2 • Presentation Blueprint</span>
    </div>
  </div>

  <!-- PAGE 2: TOP 8 LINKS, 3 VISUAL ELEMENTS, & 30-SEC JURY SCRIPT -->
  <div class="page">
    <div class="header">
      <div class="header-left">
        <h1>🔗 Top 8 High-Impact Links, Visuals & Presentation Script</h1>
        <div class="subhead">Exact Data Provenance, Jury Pitching Points, and Vocal Delivery Guide</div>
      </div>
      <div style="text-align: right; font-size: 9px; color: #64748b;">
        <div>Academic & Policy Reference Sheet</div>
      </div>
    </div>

    <!-- 3 BEST VISUAL ELEMENTS -->
    <div class="section-title">🎨 Part 3: The 3 Best Visual Elements to Put on the Slide</div>
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; margin-bottom: 8px;">
      <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 6px; padding: 6px;">
        <b style="color: #166534; font-size: 10px;">1. Three Impact Badges</b>
        <div style="font-size: 9px; color: #15803d; margin-top: 2px;">
          • <code>5,280 Schools</code> (Target)<br>
          • <code>34 MB RAM</code> (Gyanodaya)<br>
          • <code>&lt; 30 ms Latency</code> (Turn-Taking)
        </div>
      </div>
      <div style="background: #fefce8; border: 1px solid #fef08a; border-radius: 6px; padding: 6px;">
        <b style="color: #854d0e; font-size: 10px;">2. 5-Language Script Chips</b>
        <div style="font-size: 9px; color: #a16207; margin-top: 2px;">
          Show cultural validation:<br>
          <b>Ho (𑢹𑣉𑣉) • Mundari (मुण्डारी) • Santhali (ᱥᱟᱱᱛᱟᱲᱤ) • Sadri • Hindi</b>
        </div>
      </div>
      <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 6px;">
        <b style="color: #334155; font-size: 10px;">3. GitHub Research QR Code</b>
        <div style="font-size: 9px; color: #475569; margin-top: 2px;">
          Bottom-right QR anchor linking to:<br>
          <code>RESEARCH_AND_SYSTEMS_COMPARISON.md</code>
        </div>
      </div>
    </div>

    <!-- TOP 8 HIGH IMPACT LINKS -->
    <div class="section-title">🔗 Part 4: Top 8 High-Impact Links & What to Say About Each</div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 6px;">
      ...
      <div class="link-card">
        ...
        <div class="link-desc">Jharkhand has 35,443 primary schools; 5,280 in ITDA blocks with 1.48M tribal students. Retention drops from 98.2% to 61.6% by Gr 5.</div>
      ...
      <div class="link-card">
        <div class="link-card-header">
          <span class="link-title">2. ASER 2022 Rural Jharkhand</span>
          <span class="link-authority">ASER Centre / Pratham</span>
        </div>
        <div class="link-url">http://img.asercentre.org/docs/ASER%202022%20report%20pdfs/All%20India%20findings/jharkhand.pdf</div>
        <div class="link-desc">Only 21.4% of rural Gr 3 students (and 17.2% of ST students) can read a Gr 2 Hindi text. Only 16.8% do basic subtraction.</div>
      ...
      <div class="link-card">
        ...
        <div class="link-desc">Documents 8.64M ST population in Jharkhand. Santhali: 34.8% (3.01M), Kurukh: 19.6% (1.70M), Mundari: 14.8% (1.28M), Ho: 11.8% (1.02M).</div>
      ...
      <div class="link-card">
        <div class="link-card-header">
          ...
          <span class="link-authority">Ministry of Education</span>
        </div>
        <div class="link-url">https://www.education.gov.in/sites/upload_files/mhrd/files/NEP_Final_English_0.pdf</div>
        <div class="link-desc">Section 4.11-4.13 strictly mandates mother-tongue medium until Grade 5 and preparation of bilingual teaching-learning materials (TLM).</div>
      ...
      <div class="link-card">
        <div class="link-card-header">
          <span class="link-title">8. UNESCO MTB-MLE Global Framework</span>
    ...
    <div class="script-box">
      ...
      <div class="script-text">
        ...
        2. <b>Hardware Reality:</b> Bhashini requires 4.5 GB of VRAM and 4G cloud data. Jharkhand's 28,945 Gyanodaya school tablets have only <span class="emphasis">2 GB of total RAM</span> and operate in zero-connectivity forest valleys.<br>
        ...
        <span class="emphasis">SARJOM runs 100% offline in 34 MB of RAM with sub-30ms response time</span>, executing the exact constitutional mandate of NEP 2020 §4.11 and Jim Cummins' Common Underlying Proficiency."
      </div>
    </div>

    <div class="footer">
      <span>SARJOM: Department of Higher & Technical Education, Government of Jharkhand</span>
      <span>Page 2 of 2 • Pitch Script & References</span>
    </div>
  </div>
