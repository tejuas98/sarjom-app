    ...
    <div class="page-content">
      ...
      <div class="script-box">
        ...
        <div class="script-text">
          ...
          <span class="emphasis">SARJOM runs 100% offline in 34 MB of RAM with sub-30ms response time and ₹0 recurring cloud bills</span>, executing the exact constitutional mandate of NEP 2020 §4.11, NCF Foundational Stage, and Jim Cummins' Common Underlying Proficiency."
        </div>
      </div>
    </div>
