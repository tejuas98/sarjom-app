...
3. **Docs-vs-code inflation** — 34 MB/throughput benchmarks, IndexedDB, Reed-Solomon QR, EVV sync, "12/12 tests" badges, transformer-in-browser narrative are docs/simulations only. Align docs or implement; a jury opening DevTools will notice.
